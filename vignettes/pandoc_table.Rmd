...
In some cases it is also useful to split too long words with hyphens, and `pander` uses `koRpus` functionality for that. Just specify `use.hyphening` argument and have `koRpus` installed:
