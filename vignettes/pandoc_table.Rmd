...
Another possible way to define alignment is using a permanent for `table.alignment.default/table.alignment.rownames` in `panderOptions` (prefered way) or using `set.alignment` function which support setting alignment separately for cells and rownames:
