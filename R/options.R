...
#'
#' \itemize{
#'      \item \code{digits}: numeric (default: \code{2}) passed to \code{format}. Can be a vector specifying values for each column.
...
#'      \item \code{big.mark}: string (default: '') passed to \code{format}. Can be a vector specifying values for each column.
